...
static const uint16_t mnames_M5[] = { 42, 43, 44, };
static const char* const msigs_M5[] = { "()v", "()v", "()s", };
static const uint16_t plist_M5[] = { 38, 39, 40, 41 };
CLASS_OBJECT(class_M5, 3) = {
    .body = { .s = 4, .i = 0, .cn = "M5", .sc = &object_class.clazz , .an = (void*)0, .pt = { .size = 4, .offset = 0,
