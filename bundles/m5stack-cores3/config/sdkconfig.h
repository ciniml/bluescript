...
#define CONFIG_PARTITION_TABLE_CUSTOM_FILENAME "boards/m5stack-cores3/partitions.csv"
#define CONFIG_PARTITION_TABLE_FILENAME "boards/m5stack-cores3/partitions.csv"
