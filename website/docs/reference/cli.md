...
| `esp32`, `esp32s3`, `m5stack-atoms3`, `m5stack-cores3` | Homebrew, Git, Python 3, `make` | Git, Python 3, `make` or `mingw32-make`. See [Windows prerequisites](../tutorial/get-started/setup-environment-windows.md). | None (Requirements are automatically installed by setup command.) |
...
Lists all board architectures currently supported by the installed CLI version (`esp32`, `esp32s3`, `m5stack-atoms3`, `m5stack-cores3`, and `host`).
