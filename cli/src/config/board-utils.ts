...
export const BOARD_NAMES = ['esp32', 'esp32s3', 'm5stack-atoms3', 'm5stack-cores3', 'host'] as const;
...
export const ESP32_FAMILY_BOARD_NAMES = ['esp32', 'esp32s3', 'm5stack-atoms3', 'm5stack-cores3'] as const;
...
export const ESP32_BOARD_TARGETS: Record<Esp32FamilyBoardName, Esp32Target> = {
    ...
    'm5stack-cores3': 'esp32s3',   // CoreS3 / CoreS3 SE with the Stack-chan base boards
};
